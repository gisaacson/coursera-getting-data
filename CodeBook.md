...
## After reading the txt. files into R, the following steps were taken in processing the data. Significant newly-introduced variables are included in bold.
**Note that the bracketed numbers (1-5) denote the required objectives of the course project.
